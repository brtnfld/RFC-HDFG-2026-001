...
p.u.str = "level=6";
H5Pset_filter_params(plist, H5Z_FILTER_DEFLATE, H5Z_FLAG_MANDATORY, &p);
\end{minted}
...
H5Pset_filter_params(plist, H5Z_FILTER_DEFLATE,
...
H5Pset_filter_params(plist, H5Z_FILTER_DEFLATE, H5Z_FLAG_MANDATORY,
                     &H5Z_PARAMS_STR("level=6"));

/* External plugin (ZFP) via key=value string */
H5Pset_filter_params(plist, H5Z_FILTER_ZFP, H5Z_FLAG_MANDATORY,
                     &H5Z_PARAMS_STR("mode=rate, rate=3.5"));

/* Parameterless filter */
H5Pset_filter_params(plist, H5Z_FILTER_SHUFFLE, H5Z_FLAG_MANDATORY, NULL);
...
H5Pset_filter_params(plist, H5Z_FILTER_FLETCHER32, H5Z_FLAG_MANDATORY, NULL);
\end{minted}
...
herr_t H5Z_cd_pack_int64   (int64_t val,
                            unsigned *slots, size_t cap, size_t *n_used);
herr_t H5Z_cd_unpack_int64 (const unsigned *slots, size_t n_slots, int64_t *val);
...
\texttt{H5Pset\_filter\_params} (\SectionRef{sec:set-filter-params}) is the primary API.
