...
\texttt{compressor.name = "zlib", compressor.level = 6, shuffle = 1} & Blosc sub-compressor (dotted keys) \\
\texttt{compressor = \{name = "zlib", level = 6\}, shuffle = 1} & Blosc sub-compressor (inline table; equivalent) \\
