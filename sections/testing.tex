...
to a canonical identifier.  The new \texttt{description} field preserves
the display role: \texttt{H5Pget\_filter2} returns \texttt{description}
...
Plugin authors should populate \texttt{description} when upgrading to
...
\item \textbf{Human-readable display:} Move the existing freeform v2
  ...
  can also include those details as keys in the output of
