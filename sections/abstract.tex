...
optional \texttt{set\_config}/\texttt{get\_config} callbacks. An internal name registry
maps canonical filter names to IDs and is used by \texttt{h5repack} for
name-to-ID resolution; plugin loading itself remains by integer ID.
