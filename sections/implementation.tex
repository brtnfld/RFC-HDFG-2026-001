...
Name registry lookups (used internally by introspection functions, \texttt{h5repack},
and \texttt{h5dump}) are pure read operations with no I/O side effects. If the
