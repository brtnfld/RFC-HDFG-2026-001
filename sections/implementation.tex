...
regardless of whether they were set via \texttt{H5Pappend\_filter} or
\texttt{H5Pset\_filter}.

Parameter string resolution occurs at \texttt{H5Pappend\_filter}
...
\texttt{H5Pappend\_filter} call site is the simplest design that keeps the
...
\texttt{H5Pappend\_filter} returns.  This is a direct consequence of the
