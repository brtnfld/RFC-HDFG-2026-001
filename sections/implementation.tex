...
Two overloaded \texttt{setFilter} methods are added to
...
public:
    ...
    void setFilter(H5Z_filter_t filter_id, unsigned flags,
...
disabled in C++) and calls \texttt{H5Pappend\_filter}.  No new C
...
dcpl.setFilter(H5Z_FILTER_DEFLATE, H5Z_FLAG_MANDATORY, "level=6");

// Raw cd_values form (compiler selects size_t + const unsigned[] overload)
unsigned cd[] = { 6 };
dcpl.setFilter(H5Z_FILTER_DEFLATE, H5Z_FLAG_MANDATORY, 1, cd);
