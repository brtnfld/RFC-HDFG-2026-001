...
This document serves a dual role: it is the RFC submitted for HDF Group
review, and it is the design document that guides and records the
implementation. References to ``this RFC'' elsewhere in the text refer to
this document in that dual capacity.
